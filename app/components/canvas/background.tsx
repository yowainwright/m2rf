...
import { createDiagonalPatternImage, createGradientImage, createPolkaPinPatternImage } from '@/app/graph';
...
const getPatternBackgroundSize = (preset: CanvasBackgroundPreset, size: number) => {
