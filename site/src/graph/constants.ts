import type {
  CanvasBackground, GraphInputFormat, GraphTranslationSettings, NodeBorder, NodeShadow, NodeSurface,
} from './types';
...
export const NODE_SURFACE_OPTIONS: Array<{ label: string; preview: string; value: NodeSurface }> = [
  ...
  { label: 'Ocean gradient', preview: 'linear-gradient(135deg, #2563eb, #06b6d4)', value: 'gradient-ocean' },
  { label: 'Sunset gradient', preview: 'linear-gradient(135deg, #2563eb, #f97316)', value: 'gradient-sunset' },
